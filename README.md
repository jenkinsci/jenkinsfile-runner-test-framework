...
In case it's desired to build the docker image using the [Custom War Packager](https://github.com/jenkinsci/custom-war-packager) it is possible to specify a concrete version (released, timestamped snapshot or incremental), although the framework defines a default version.
